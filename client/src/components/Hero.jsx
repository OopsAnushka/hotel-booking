...
const Hero = () => {
  return (
    <div className='flex flex-col items-start justify-centre px-6 pb-8 md:px-16 lg:px-24 xl:px-32 text-white bg-[url("/src/assets/heroImage.png")] bg-no-repeat bg-cover bg-center h-screen'>
        ...
        <form className='bg-white/10 backdrop-blur-md text-white-500 rounded-lg px-6 py-4  flex flex-col md:flex-row max-md:items-start gap-4 max-md:mx-auto mt-10 max-md:mt-4'>

            <div>
                <div className='flex items-center gap-2 max-md:h-5'>

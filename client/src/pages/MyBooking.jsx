  ...
  return (
    <div className='py-28 md:pb-35 md:pt-32 px-4 md:px-16 lg:px-24 xl:px-32'>
        ...
        <div className='max-w-6xl mt-8 w-full text-gray-800'>
            ...
            <div className='hidden md:grid md:grid-cols-[3fr_2fr_1fr] w-full border-b border-gray-300 font-medum text-base py-3'>
            ...
            {bookings.map((bookings)=>(
                <div key={bookings._id} className='grid grid-cols-1 md:grid-cols-[3fr_2fr_1fr] w-full border-b border-gray-300 py-6 first:border-t'>
                 ...
                 <div className='flex flex-col md:flex-row'> 
                    <img src={bookings.room.images[0]} alt="hotel-image" className='min-md:w-44 rounded shadow object-cover' />
                ...
                <div>
                 ...
                 <div className='flex flex-col items-start justify-center pt-3'>
                    <div className='flex items-center gap-2'>
                      ...
                      {!bookings.isPaid && (
                        <button className='px-4 py-1.5 mt-4 text-xs border border-gray-400 rounded-full hover:bg-green-200 transition-all cursor-pointer'>Pay Now
                        </button>
                      )}
                 </div>
                </div>

...
const ListRoom = () => {
  ...
  return (
    <div>
      ...
      <div className='w-full max-w-3xl text-left border border-gray-300 rounded-lg max-h-80 overflow-y-auto overflow-x-auto mt-3'>
        <table className='w-full min-w-[600px]'>
          <thead className='bg-gray-50'>
            <tr>
              ...
              <th className='px-4 py-3 text-gray-800 font-medium text-center'>Actions</th>
            </tr>
          </thead>
